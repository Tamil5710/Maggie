...
const Hero = () => {
  return (
    <div className="hero">
      ...
      <img src="/images/basil1.png" alt="basil" className="bg-basil b1" />
      <img src="/images/basil1.png" alt="basil" className="bg-basil b2" />
      ...
      <div className="bowl-container">
        ...
        <div className="bowl-text">
          <motion.p custom={0} variants={textVariant} initial="hidden" animate="visible">
            Hot, tasty, and ready in minutes — your quick fix for hunger without compromising on taste.
          </motion.p>

          <motion.p className="one-p" custom={1} variants={textVariant} initial="hidden" animate="visible">
            Made with love, fresh ingredients, and the perfect blend of spices for that homemade touch.
          </motion.p>

          <motion.button className="cta-btn" custom={2} variants={textVariant} initial="hidden" animate="visible">
            Order Now
          </motion.button>
        </div>
